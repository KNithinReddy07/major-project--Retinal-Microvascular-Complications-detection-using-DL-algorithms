...
def model_predict2(image_path,model):
    ...
    if result == 0:
        return "The Patient is Diagnosis with Mild DR","result.html"        
    elif result == 1:
        return "The Patient is Diagnosis with Moderate DR","result.html"
    elif result == 2:
        return "The Patient is Diagnosis with Normal DR","result.html"
    elif result == 3:
        return "The Patient is Diagnosis with Proliferate DR","result.html"
    elif result == 4:
        return "The Patient is Diagnosis with Severe DR","result.html"
